...
[Authorize]
public sealed class ReportsModel(UserManager<ApplicationUser> userManager, ApplicationDbContext db, InstitutionTimeService institutionTime, IOptions<AttendanceReportingOptions> reportingOptions) : PageModel
{
    ...
    public async Task OnGetAsync()
    {
        ...
        Introduction = IsLecturer
            ? "Explore participation trends, compare lectures, and identify students who may need support."
            : "Explore your attendance pattern, course performance, and consistency over time.";
